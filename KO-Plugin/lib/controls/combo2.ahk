...
Iniread, pkmodeskills, %A_WorkingDir%/../ParallaxSettings.ini, EDITS, combo2Text
IniRead, WActivateChecked, %A_WorkingDir%/../ParallaxSettings.ini, CHECKBOXES, WActivateChecked
IniRead, MinorActivateChecked, %A_WorkingDir%/../ParallaxSettings.ini, CHECKBOXES, MinorActivateChecked

;Edits
IniRead, GUIDelay1				, %A_WorkingDir%/../ParallaxSettings.ini, EDITS, GUIDelay1
IniRead, GUIDelay2				, %A_WorkingDir%/../ParallaxSettings.ini, EDITS, GUIDelay2
IniRead, CureSpeed				, %A_WorkingDir%/../ParallaxSettings.ini, EDITS, CureSpeed
IniRead, ThrowingKnifeSpeed		, %A_WorkingDir%/../ParallaxSettings.ini, EDITS, ThrowingKnifeSpeed
IniRead, MagicShieldSpeed		, %A_WorkingDir%/../ParallaxSettings.ini, EDITS, MagicShieldSpeed
IniRead, VampiricTouchSpeed		, %A_WorkingDir%/../ParallaxSettings.ini, EDITS, VampiricTouchSpeed
IniRead, IllusionSpeed			, %A_WorkingDir%/../ParallaxSettings.ini, EDITS, IllusionSpeed
IniRead, ArmCancelSpeed			, %A_WorkingDir%/../ParallaxSettings.ini, EDITS, ArmCancelSpeed
IniRead, BloodDrainSpeed			, %A_WorkingDir%/../ParallaxSettings.ini, EDITS, BloodDrainSpeed
IniRead, DelayBetweenTwoSkills	, %A_WorkingDir%/../ParallaxSettings.ini, EDITS, DelayBetweenTwoSkills
IniRead, pageSpeed, %A_WorkingDir%/../ParallaxSettings.ini, EDITS, pageSpeed

;Hotkeys 
IniRead, CriticalNumber, 	%A_WorkingDir%/../ParallaxSettings.ini, HOTKEYS, CriticalNumber
IniRead, CriticalPage, 		%A_WorkingDir%/../ParallaxSettings.ini, HOTKEYS, CriticalPage
IniRead, VampiricTouchPage, 	%A_WorkingDir%/../ParallaxSettings.ini, HOTKEYS, VampiricTouchPage
IniRead, VampiricTouchNumber, %A_WorkingDir%/../ParallaxSettings.ini, HOTKEYS, VampiricTouchNumber
IniRead, IllusionNumber, 	%A_WorkingDir%/../ParallaxSettings.ini, HOTKEYS, IllusionNumber
IniRead, IllusionPage, 		%A_WorkingDir%/../ParallaxSettings.ini, HOTKEYS, IllusionPage
...
IniRead, ThrowingKnifeNumber, %A_WorkingDir%/../ParallaxSettings.ini, HOTKEYS, ThrowingKnifeNumber
IniRead, MagicShieldPage, 	%A_WorkingDir%/../ParallaxSettings.ini, HOTKEYS, MagicShieldPage
IniRead, ThrowingKnifePage, 	%A_WorkingDir%/../ParallaxSettings.ini, HOTKEYS, ThrowingKnifePage
IniRead, MagicShieldNumber, 	%A_WorkingDir%/../ParallaxSettings.ini, HOTKEYS, MagicShieldNumber
IniRead, ManaNumber, 		%A_WorkingDir%/../ParallaxSettings.ini, HOTKEYS, ManaNumber
IniRead, LightFeetNumber, 	%A_WorkingDir%/../ParallaxSettings.ini, HOTKEYS, LightFeetNumber
IniRead, MinorNumber, 		%A_WorkingDir%/../ParallaxSettings.ini, HOTKEYS, MinorNumber
IniRead, HealthNumber, 		%A_WorkingDir%/../ParallaxSettings.ini, HOTKEYS, HealthNumber
...
IniRead, BloodDrainNumber, 	%A_WorkingDir%/../ParallaxSettings.ini, HOTKEYS, BloodDrainNumber
IniRead, BloodDrainPage, 	%A_WorkingDir%/../ParallaxSettings.ini, HOTKEYS, BloodDrainPage
	...
	if(counter == 1){
		...
		Loop{
			for i, v in (array := StrSplit(pkmodeskills, ",")) {
				...
				nextskill := array[i + 1]
				IniWrite, %nextskill%, ParallaxSettings.ini, Next, Next
...
ATT_PageChange(Page){ 
	...
	IniWrite, %previousf%, ParallaxSettings.ini, Page, Page
